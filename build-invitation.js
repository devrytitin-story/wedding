...
<section class="hero" id="hero" data-cam="0">
  ...
  <a class="peek" href="#pathways" data-view="3" data-rv="fade" data-cursor aria-label="Lihat Pendopo Janji Suci">
    ...
    <span class="peek-cap"><b class="font-cinzel" style="font-size:16px; color:var(--gold-light); letter-spacing:2px;">2026</b><i>Pendopo Janji Suci</i></span>
  </a>
...
<section class="sec" id="pathways" data-cam="2">
  <div class="sec-glass-card">
    ...
    <div style="margin-top: 50px;" class="sec-head" data-rv="fade">
      <span class="k"><b>Pelataran Doa</b> — Sudut Ketenangan</span><span class="rule"></span><span class="k font-cinzel" style="font-size:11px; letter-spacing:2px; color:var(--gold-pale);">PRAYERS</span>
    </div>
    <div class="cards" id="cards">
      <article class="card" data-rv="up" data-view="0" data-cursor>
        <div class="card-fr" data-frame>
          ...
          <div class="card-lab"><b>Pendopo Utama</b><span class="font-cinzel" style="font-size:11px; color:var(--gold-pale);">AKAD</span></div>
        </div>
      ...
      <article class="card" data-rv="up" data-view="1" data-cursor>
        <div class="card-fr" data-frame>
          ...
          <div class="card-lab"><b>Lampu Ting Antik</b><span class="font-cinzel" style="font-size:11px; color:var(--gold-pale);">DOA</span></div>
        </div>
      ...
      <article class="card" data-rv="up" data-view="2" data-cursor>
        <div class="card-fr" data-frame>
          ...
          <div class="card-lab"><b>Roncean Melati</b><span class="font-cinzel" style="font-size:11px; color:var(--gold-pale);">CINTA</span></div>
        </div>
