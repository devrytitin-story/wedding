...
<section class="sec" id="gift" data-cam="4">
  <div class="sec-glass-card" style="text-align: center;">
    ...
    <div class="gift-grid" data-rv="up">
      <!-- Rekening Mempelai Pria (Devry) -->
      <div class="gift-card">
        <div>
          <span class="gift-bank-badge">BANK TRANSFER</span>
          <div class="gift-bank-name font-cinzel">BCA</div>
          <p class="gift-holder">a.n. <b>Devry Rizkie H</b></p>
        </div>
        <div class="gift-number-box">
          <span class="gift-number" id="acc-devry">8415123456</span>
          <button class="gift-copy-btn" onclick="copyGiftText('acc-devry', 'Nomor rekening BCA')" title="Salin No. Rekening">
      ...
      <!-- Rekening Mempelai Wanita (Titin) -->
      <div class="gift-card">
        <div>
          <span class="gift-bank-badge">BANK TRANSFER</span>
          <div class="gift-bank-name font-cinzel">MANDIRI / BSI</div>
          <p class="gift-holder">a.n. <b>Titin Rahma Lestari</b></p>
        </div>
        <div class="gift-number-box">
          <span class="gift-number" id="acc-titin">1230009876543</span>
          <button class="gift-copy-btn" onclick="copyGiftText('acc-titin', 'Nomor rekening')" title="Salin No. Rekening">
            <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
            <span>Salin</span>
          </button>
        </div>
  ...
  <div class="foot-grid" style="margin-top: 60px;">
    ...
    <div>
      ...
      <ul>
        ...
        <li><a href="#gift" data-cursor>Tanda Kasih</a></li>
